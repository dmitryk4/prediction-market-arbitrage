      ...
      <main className="app-main">
        <section className="panel">
          ...
          <p className="panel-text">
            ...
            platforms and highlights pricing discrepancies, while keeping all
            execution and capital allocation out of scope.
          </p>
          <button
          ...
          >
            {state === "loading" ? "Scanning markets…" : "Scan for opportunities"}
          </button>
          {state === "idle" && (
            <p className="hint">
